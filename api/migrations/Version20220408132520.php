 ...
 */
final class Version20220408132520 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE `user` (id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', name_id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', location_id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', login_id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', registered_id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', picture_id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', gender VARCHAR(10) NOT NULL, email VARCHAR(255) NOT NULL, phone VARCHAR(255) DEFAULT NULL, cell VARCHAR(255) DEFAULT NULL, nat VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_8D93D64971179CD6 (name_id), UNIQUE INDEX UNIQ_8D93D64964D218E (location_id), UNIQUE INDEX UNIQ_8D93D6495CB2E05D (login_id), UNIQUE INDEX UNIQ_8D93D64933F613ED (registered_id), UNIQUE INDEX UNIQ_8D93D649EE45BDBF (picture_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE `user_login` (id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', username VARCHAR(150) NOT NULL, password VARCHAR(255) NOT NULL, salt VARCHAR(255) NOT NULL, md5 VARCHAR(255) NOT NULL, sha1 VARCHAR(255) NOT NULL, sha256 VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
